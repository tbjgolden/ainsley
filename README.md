...
+----------------+-------+-----------+------------+
| minified bytes | 3,448 |     1,883 |    738,830 |
++---------------+-------+-----------+------------+
 | gzipped bytes | 1,431 |       920 |    132,425 |
 ++--------------+-------+-----------+------------+
  | brotli bytes | 1,228 |       847 |     22,485 |
  +-+------------+-------+-----------+------------+
    | TOTAL SENT |             2,075 |     22,485 |
    +------------+-------------------+------------+
```
...
| :------------ | -----------: | ---------: | ---------: | ------------: | ---------------: | ----------: | ----------: | ---------: |
| **ainsley**   |   **`5,331`** | **`2,351`** | **`2,075`** |   **`21,720`** |       **`7.58`** | **`4,272`** | **`1,263`** |      `115` |
