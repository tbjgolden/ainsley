...
| Framework     |   Minified |       Gzip |     Brotli |   CSS Rules |      Load 1 |      Load 2 |   Load 3 |
| ------------- | ---------: | ---------: | ---------: | ----------: | ----------: | ----------: | -------: |
| **ainsley**   | **`5,742`** | **`2,414`** | **`2,103`** | **`22,580`** | **`4,272`** | **`1,263`** |    `115` |
| tailwindcss   |  `710,997` |   `97,417` |   `10,199` |    `14,445` |    `18,031` |     `5,075` |    `183` |
| tachyons      |   `73,497` |   `13,697` |    `2,421` |     `2,113` |     `5,606` |     `1,621` | **`71`** |
| sane-tachyons |   `49,793` |    `9,200` |    `1,957` |     `1,278` |     `5,345` |     `1,552` |     `75` |
| turretcss     |   `93,542` |   `17,025` |    `4,311` |     `1,588` |       n/a\* |       n/a\* |    n/a\* |
| solid         |   `82,482` |   `12,585` |    `2,497` |     `1,469` |       n/a\* |       n/a\* |    n/a\* |
| basscss       |   `11,326` |    `2,477` |      `589` |       `260` |       n/a\* |       n/a\* |    n/a\* |
