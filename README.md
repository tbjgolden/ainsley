...
+----------------+-------+-----------+------------+
| minified bytes | 3,839 |     1,704 |    767,408 |
++---------------+-------+-----------+------------+
 | gzipped bytes | 1,531 |       868 |    138,793 |
 ++--------------+-------+-----------+------------+
  | brotli bytes | 1,301 |       793 |     23,526 |
  +-+------------+-------+-----------+------------+
    | TOTAL SENT |             2,094 |     23,526 |
    +------------+-------------------+------------+
```
...
| :------------ | -----------: | ---------: | ---------: | ------------: | ---------------: | ----------: | ----------: | ---------: |
| **ainsley**   |   **`5,543`** | **`2,399`** | **`2,094`** |   **`22,800`** |     **`10.89`** | **`4,272`** | **`1,263`** |      `115` |
