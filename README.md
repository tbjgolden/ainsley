...
| Framework     |   Minified |       Gzip |     Brotli |   CSS Rules | Efficiency\* |      Load 1 |      Load 2 |   Load 3 |
| ------------- | ---------: | ---------: | ---------: | ----------: | -------------: | ----------: | ----------: | -------: |
...
| turretcss     |   `93,542` |   `17,025` |    `4,311` |     `1,588` | 0.36 |       n/a\* |       n/a\* |    n/a\*\* |
| solid         |   `82,482` |   `12,585` |    `2,497` |     `1,469` | 0.58 |       n/a\* |       n/a\* |    n/a\*\* |
| basscss       |   `11,326` |    `2,477` |      `589` |       `260` | 0.44 |       n/a\* |       n/a\* |    n/a\*\* |
