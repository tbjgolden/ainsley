...
+----------------+-------+-----------+------------+
| minified bytes | 3,448 |     1,844 |    738,830 |
++---------------+-------+-----------+------------+
 | gzipped bytes | 1,431 |       910 |    132,425 |
 ++--------------+-------+-----------+------------+
  | brotli bytes | 1,228 |       841 |     22,485 |
  +-+------------+-------+-----------+------------+
    | TOTAL SENT |             2,069 |     22,485 |
    +------------+-------------------+------------+
```
...
| :------------ | -----------: | ---------: | ---------: | ------------: | ---------------: | ----------: | ----------: | ---------: |
| **ainsley**   |   **`5,292`** | **`2,341`** | **`2,069`** |   **`21,720`** |       **`4.10`** | **`4,272`** | **`1,263`** |      `115` |
