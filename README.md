...
+----------------+-------+-----------+------------+
| minified bytes | 4,072 |     2,071 |    761,941 |
++---------------+-------+-----------+------------+
 | gzipped bytes | 1,591 |       961 |    137,658 |
 ++--------------+-------+-----------+------------+
  | brotli bytes | 1,353 |       864 |     23,161 |
  +-+------------+-------+-----------+------------+
    | TOTAL SENT |             2,217 |     23,161 |
    +------------+-------------------+------------+
```
...
| ------------- | -----------: | ---------: | ---------: | ------------: | ---------------: | ----------: | ----------: | ---------: |
| **ainsley**   |   **`6,143`** | **`2,552`** | **`2,217`** |   **`22,580`** |     **`10.18`** | **`4,272`** | **`1,263`** |      `115` |
