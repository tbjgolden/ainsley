...
+----------------+-------+-----------+------------+
| minified bytes | 4,665 |     1,883 |    740,036 |
++---------------+-------+-----------+------------+
 | gzipped bytes | 2,036 |       920 |    133,136 |
 ++--------------+-------+-----------+------------+
  | brotli bytes | 1,746 |       847 |     22,952 |
  +-+------------+-------+-----------+------------+
    | TOTAL SENT |             2,593 |     22,952 |
    +------------+-------------------+------------+
```
...
| :------------ | -----------: | ---------: | ---------: | ------------: | ---------------: | ----------: | ----------: | ---------: |
| **ainsley**   |   **`6,548`** | **`2,956`** | **`2,593`** |   **`21,729`** |       **`6.09`** | **`4,272`** | **`1,263`** |      `115` |
