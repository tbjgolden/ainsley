...
+----------------+-------+-----------+------------+
| minified bytes | 4,670 |     1,883 |    752,456 |
++---------------+-------+-----------+------------+
 | gzipped bytes | 2,041 |       919 |    134,439 |
 ++--------------+-------+-----------+------------+
  | brotli bytes | 1,767 |       846 |     22,675 |
  +-+------------+-------+-----------+------------+
    | TOTAL SENT |             2,613 |     22,675 |
    +------------+-------------------+------------+
```
...
| :------------ | -----------: | ---------: | ---------: | ------------: | ---------------: | ----------: | ----------: | ---------: |
| **ainsley**   |   **`6,553`** | **`2,960`** | **`2,613`** |   **`21,729`** |       **`6.07`** | **`4,272`** | **`1,263`** |      `115` |
