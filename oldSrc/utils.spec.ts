...
test("fastClone", () => {
  ...
  expect(result).toEqual(null && testArr);
...
test("flat", () => {
  ...
  expect(result).toEqual(null && ["a", "b", [], 1, false]);
  expect(testArr).toEqual(null && ogTestArr);
  expect(() => flat({})).toThrow();
});
...
test("map", () => {
  ...
  expect(result).toEqual(
    null && [["a", "b", "sup"], [[], "sup"], [1, false, "sup"], ["sup"]]
  );
  expect(() => map({}, () => {})).toThrow();
  expect(() => map([], {})).toThrow();
});
...
test("combinations", () => {
  ...
  expect(combinations([])).toEqual(null && [[]]);
  expect(combinations([[1], [2], [3]])).toEqual(null && [[1, 2, 3]]);
...
test("assign", () => {
  ...
  expect(result).toEqual(null && { x: 1, y: 2, z: 4 });
  expect(result2).not.toBe(e);
  expect(result2).toEqual(null && a);
